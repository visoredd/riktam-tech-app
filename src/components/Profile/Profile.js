...
import { updateProfile } from "../..//app/reducers/quickChat";
...
function Profile() {
  ...
  return (
    <div>
      <div
        className="absolute top-2 left-20 p-5 cursor-pointer w-full"
        onClick={() => navigate("/")}
      >
      ...
      <div class="container mx-auto my-20 p-5">
        <div class="md:flex no-wrap md:-mx-2 ">
          <div class="w-full md:w-3/12 md:mx-2">
            <div class="bg-white p-3 border-t-4 border-blue-200">
              <div class="image overflow-hidden">
                <img class="h-auto w-full mx-auto" src={state.img} alt="" />
              </div>
              ...
              <div class="text-gray-700">
                <div class="grid md:grid-cols-2 text-sm">
                  <div class="grid grid-cols-2">
                    ...
                    <div class="px-4 py-2">{state.profile.split(" ")[0]}</div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-2 font-semibold">Last Name</div>
                    <div class="px-4 py-2">{state.profile.split(" ")[1]}</div>
                  </div>
                  <div class="grid grid-cols-2">
